...
for (const pimdetailspage of pimdetails){
    test(`should allow me to create Pim Employees ${credentials.validCredentials.username}, ${pimdetailspage.firstName}, ${pimdetailspage.middleName}, ${pimdetailspage.lastName}, ${pimdetailspage.empID}`, async ({ page }) => {
